...
public class FileClassAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.fileclass_add); 
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("添加文档分类");
			...
			public void onClick(View v) {
				try {
					...
					if(ET_className.getText().toString().equals("")) {
						Toast.makeText(FileClassAddActivity.this, "分类名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传文档分类信息*/
					FileClassAddActivity.this.setTitle("正在上传文档分类信息，稍等...");
					String result = fileClassService.AddFileClass(fileClass);
