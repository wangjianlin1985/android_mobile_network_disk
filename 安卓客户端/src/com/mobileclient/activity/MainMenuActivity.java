...
public class MainMenuActivity extends Activity {
    ...
    public class ImageAdapter extends BaseAdapter {
        ...
        private String[] menuString = {"用户管理","文档分类管理","文档管理","是否信息管理","新闻公告管理"};
        ...
        public View getView(int position, View convertView, ViewGroup parent) { 
			...
			iv.setImageResource(mThumbIds[position]); 
			  switch (position) {
				...
				case 1:
					// 文档分类管理监听器
					view.setOnClickListener(fileClassLinstener);
					break;
				case 2:
					// 文档管理监听器
					view.setOnClickListener(fileInfoLinstener);
					break;
				case 3:
					// 是否信息管理监听器
    ...
    OnClickListener fileClassLinstener = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent();
			// 启动文档分类管理Activity
			intent.setClass(MainMenuActivity.this, FileClassListActivity.class);
			startActivity(intent);
		}
	};
    OnClickListener fileInfoLinstener = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent();
			// 启动文档管理Activity
			intent.setClass(MainMenuActivity.this, FileInfoListActivity.class);
			startActivity(intent);
		}
	};
