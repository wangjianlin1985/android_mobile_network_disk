...
public class YesOrNoService {
	...
	public String AddYesOrNo(YesOrNo yesOrNo) {
		...
		params.put("yesNoId", yesOrNo.getYesNoId() + "");
		params.put("yesNoName", yesOrNo.getYesNoName());
	...
	public List<YesOrNo> QueryYesOrNo(YesOrNo queryConditionYesOrNo) throws Exception {
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				yesOrNo.setYesNoId(object.getInt("yesNoId"));
				yesOrNo.setYesNoName(object.getString("yesNoName"));
