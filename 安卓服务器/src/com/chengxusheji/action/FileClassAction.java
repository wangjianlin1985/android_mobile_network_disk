...
public class FileClassAction extends BaseAction {
    ...
    public String AddFileClass() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("FileClass添加成功!"));
            return "add_success";
            ...
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("FileClass添加失败!"));
            return "error";
        }
    }
    ...
    public String QueryFileClassOutputToExcel() { 
		...
		*/
		...
		try { 
			...
			response.setHeader("Content-disposition","attachment; filename="+"FileClass.xls");//filename是下载的xls的名，建议最好用英文 
    ...
    public String ModifyFileClass() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("FileClass信息更新成功!"));
            return "modify_success";
        } catch (Exception e) {
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("FileClass信息更新失败!"));
            return "error";
       }
   }
    ...
    public String DeleteFileClass() {
        ...
        try { 
            ...
            ctx.put("message",  java.net.URLEncoder.encode("FileClass删除成功!"));
            return "delete_success";
        } catch (Exception e) { 
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("FileClass删除失败!"));
            return "error";
        }
    }
