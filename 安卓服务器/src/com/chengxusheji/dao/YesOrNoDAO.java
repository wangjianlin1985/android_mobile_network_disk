...
public class YesOrNoDAO {
    ...
    /*根据主键获取对象*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public YesOrNo GetYesOrNoByYesNoId(int yesNoId) {
        Session s = factory.getCurrentSession();
        YesOrNo yesOrNo = (YesOrNo)s.get(YesOrNo.class, yesNoId);
        return yesOrNo;
    }
    ...
    /*删除YesOrNo信息*/
    public void DeleteYesOrNo (int yesNoId) throws Exception {
        Session s = factory.getCurrentSession();
        Object yesOrNo = s.load(YesOrNo.class, yesNoId);
        s.delete(yesOrNo);
    }
